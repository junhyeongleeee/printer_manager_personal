...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  //     _loginFailed = false;
  //     print("_loginFailed = false");
  //   } else {
  //     _loginFailed = true;
  //     print("_loginFailed = true");
  //   }
  // }
  //
  // void _attemptLogin() async {
  //   // TODO: 서버 연동은 나중에, 일단 임시 성공으로 실패 처리
  //   // 로그인 호출 예시 (login_page.dart)
  //
  //
  //   setState(() {
  //     _loginFailed = false;
  ...
  //     _isLoginFail();
  //
  //     // if (_idController.text == '1234567890' && _pwController.text == '0000') {
  //     //   _loginFailed = false;
  //     // } else {
  //     //   _loginFailed = true;
  //     // }
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder( // 버튼 모서리 둥글게 (선택)
